...
def game(nickname):
    ...
    newss = [  #[글, 주식 타입, 업/다운] 0: 주식, 1: 아무것도 아님, 2: 광물 / 1: up, 2: down
        ...
        ["전세계 희귀 광물 공급량의 약 70%를 담당하고 있는 조선 광산에서 대규모 반제국주의 파업 행위가 일어났습니다. 일제는 진압을 위해 무력을 동원했지만 시위가 끝날 기미는 보이지 않습니다.", 2, 1],
        ["걷잡을 수 없이 상승하는 물가를 안정시키기 위한 대책으로 기준 금리를 대폭 늘리자는 주장이 점점 힘을 얻고 있습니다. 이에 의해 주식 시장이 큰 영향을 입을 것으로 보입니다.", 0, 2],
        ["신기한 사실: 말미잘은 음식이 들어가는 통로와 배설물이 나가는 통로가 같답니다!", 1],
        ["지속되는 높은 실업률을 해결하기 위해 금리를 인하한다고 합니다. 하지만 전문가들은 금리 인하가 실업률 감소에 별 도움을 주지 못할 것이라고 합니다."], 0, 1]
